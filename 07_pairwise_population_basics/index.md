...
```
    ...
    Differential(t, 1)(RR(t)) ~ 2IR(t)*γ
    Differential(t, 1)(IR(t)) ~ II(t)*γ + 0.8333333333333334ifelse(S(t) == 0, 0, (SR(t)*SI(t)) / S(t))*τ - IR(t)*γ
    Differential(t, 1)(II(t)) ~ -2II(t)*γ + 1.6666666666666667ifelse(S(t) == 0, 0, (SI(t)^2) / S(t))*τ + 2SI(t)*τ
    Differential(t, 1)(SR(t)) ~ -0.8333333333333334ifelse(S(t) == 0, 0, (SR(t)*SI(t)) / S(t))*τ + SI(t)*γ
    Differential(t, 1)(SI(t)) ~ -0.8333333333333334ifelse(S(t) == 0, 0, (SI(t)^2) / S(t))*τ - SI(t)*γ - SI(t)*τ + 0.8333333333333334ifelse(S(t) == 0, 0, (SS(t)*SI(t)) / S(t))*τ
    Differential(t, 1)(SS(t)) ~ -1.6666666666666667ifelse(S(t) == 0, 0, (SS(t)*SI(t)) / S(t))*τ
    Differential(t, 1)(R(t)) ~ I(t)*γ
    Differential(t, 1)(I(t)) ~ -I(t)*γ + SI(t)*τ
    Differential(t, 1)(S(t)) ~ -SI(t)*τ
...
```
    ...
    S(∞) ≈ 0.0014287758837220913
    R(∞) ≈ 0.9985712203568636

For $\tau=0.2$, $\gamma=0.1$, $k=6$, the pair-approximation R₀ is
$\tau(n-2)/\gamma = 8$, so we expect a near-complete attack.
