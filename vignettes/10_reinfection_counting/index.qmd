...
author: "Simon Frost"
date: today
subtitle: "NodeBasedModels.jl Vignette 10 (Keeling et al. 2016 reinfection counting)"
format:
  html:
    toc: true
    code-fold: false
...
giving $\tau = 0.5$. Initial prevalence $\varepsilon = 0.01$ matches the
canonical $S(0) = 990,\, I(0) = 10$ on $N = 1{,}000$.
