...
function final_R(τ_val; γ_val = 0.1, n = 6, T = 400.0)
    ...
    psys = generate_pairwise(sir_model(), net, BernoulliClosure();
                             tspan = (0.0, T), N = 1.0)
    ic = copy(psys.u0)
    S0, I0 = 0.999, 0.001; k = Float64(n)
    ic[psys.singles[:S]] = S0; ic[psys.singles[:I]] = I0; ic[psys.singles[:R]] = 0.0
...
net = regular_network(6)
psys = generate_pairwise(sir_model(), net, BernoulliClosure();
                          tspan = (0.0, 30.0), N = 1.0)
ic = copy(psys.u0)
S0, I0 = 0.999, 0.001; k = 6.0
ic[psys.singles[:S]] = S0; ic[psys.singles[:I]] = I0; ic[psys.singles[:R]] = 0.0
ic[psys.pairs[(:S,:S)]] = k*S0*S0; ic[psys.pairs[(:S,:I)]] = k*S0*I0
ic[psys.pairs[(:S,:R)]] = 0.0
ic[psys.pairs[(:I,:I)]] = k*I0*I0; ic[psys.pairs[(:I,:R)]] = 0.0
ic[psys.pairs[(:R,:R)]] = 0.0
p = copy(psys.params); p[:τ] = 0.2; p[:γ] = 0.1
prob = ODEProblem(psys.system, merge(ic, p), psys.tspan)
sol  = solve(prob; reltol = 1e-10, abstol = 1e-12)
